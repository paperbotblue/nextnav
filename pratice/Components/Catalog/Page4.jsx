...
function Page4() {
  return (
    <div className="relative max-w-[120em] mx-auto flex flex-col lg:flex-row items-start lg:pl-10 p-3 h-full lg:h-1/2">
      ...
      {/* Content section */}
      <div className="relative z-10 w-full md:w-[90%]  self-center lg:w-1/2 bg-[#56514d] bg-opacity-75 p-3">
        <h1 className="text-4xl text-white mb-4">Introduction</h1>
        ...
        <p className="text-white font-bold">Eng. Sameh Al Shahaby</p>
