  ...
  return (
    <div className="flex justify-center ">
      <div className="relative flex overflow-hidden  top-0 2xl:max-w-[120em] w-full h-full">
        ...
        >
          <div
            className={`relative z-50 hidden md:flex justify-between w-[99%] p-1  ${
              scrolling
                ? "2xl:h-[5rem] xl:h-[4.3rem] lg:h-[3.5rem] md:h-[2.6rem] h-[2.5rem]"
                : "2xl:h-[5.5rem] xl:h-[4.8rem] lg:h-[4rem] md:h-[3.4rem] h-[3rem]"
            }`}
          >
                ...
                >
                  <div className="relative z-50 flex w-full lg:ml-6 md:ml-3 bg-white h-full pt-1 cursor-pointer items-center">
                    <img
                      ...
                      className={`${
                        scrolling
                          ? "2xl:w-[3.3rem] xl:w-[2.9rem] lg:w-[2.5rem] md:w-[1.7rem] w-[1.5rem]"
                          : "2xl:w-[3.5rem] xl:w-[3.1rem] lg:w-[2.7rem] md:w-[1.9rem] w-[1.5rem]"
                      }`}
                    ></img>
                    <img
                      src={Logo2}
                      className={`w-full ${
                        scrolling
                          ? "2xl:h-[2.2rem] xl:h-[2rem] lg:h-[1.6rem] md:h-[1.2rem] h-[1.3rem]"
                          : "2xl:h-[2.3rem] xl:h-[1.9rem] lg:h-[1.7rem] md:h-[1.3rem] h-[1.2rem]"
                      }`}
                    ></img>
                  </div>
                </Link>
                  ...
                  {Navdata.map((item, index) => (
                    ...
                    key={item.id || index}
                      className={`relative group  ${
                        scrolling
                          ? "2xl:h-[2.5rem] xl:h-[2rem] lg:h-[1.5rem] md:h-[1.5rem]"
                          : "2xl:h-[3rem] xl:h-[2.5rem] lg:h-[2rem] md:h-[1.5rem]"
                      }`}
                    >
                      <NavLink
                        to={item.add ? item.add : undefined}
                        onClick={() => {
                          window.scrollTo({ top: 0, behavior: "smooth" });
                          handleButtonClick();
                        }}
                      ...
                      >
                        <button
                          className={` w-max  2xl:px-3 xl:px-2 lg:px-2 md:px-1 h-full ${
                            isButtonClicked && "group"
                          } 2xl:text-lg xl:text-base lg:text-xs  text-[0.65rem] font-extralight font-NavMenuFont`}
                        >
                          {item.buttoname}
                          <div
                            className={` w-0 duration-500 h-[2px] ${
                              !isButtonClicked && "group-hover:w-full"
                            } bg-black `}
                          ></div>
                        </button>
                      </NavLink>
                      {item.subbuthai && (
                        <div
                          className={`bg-transparent absolute ${
                            isButtonClicked
                              ? "overflow-hidden"
                              : "group-hover:translate-y-2 group-hover:h-max overflow-hidden"
                          } duration-500 bg-slate-500 h-0 ${
                            scrolling
                              ? "2xl:top-[1.5rem] xl:top-[1.5rem] lg:top-[1rem] md:top-[1rem] 2xl:w-[13rem] xl:w-[12rem] lg:w-[11rem] md:w-[10rem]"
                              : "2xl:top-[2.5rem] xl:top-[1.5rem] lg:top-[1rem] md:top-[1rem] 2xl:w-[14rem] xl:w-[13rem] lg:w-[12rem] md:w-[11rem]"
                          }`}
                        >
                          <div
                          ...
                          >
                            {item.subbut.map((sub, index) => (
                              <button
                                key={sub.id || index}
                                className="text-white text-base font-subMenuFont border-b-[1px] pb-2 w-full text-left hover:scale-105 duration-300"
                                onClick={() => {
                                  navigate(sub.link);
                                  handleButtonClick();
                                }}
            ...
            <div className="relative z-10 w-[25%] h-full px-2 pr-2 2xl:gap-6 xl:gap-5 lg:gap-4 md:gap-3 gap-2 text-gray-100 flex justify-end items-center">
              <IoMdCall
                className={`${
                  scrolling
                    ? "2xl:text-[2.2rem] xl:text-[1.9rem] lg:text-[1.6rem] md:text-[1.3rem] text-[1rem]"
                    : "2xl:text-[2.5rem] xl:text-[2.2rem] lg:text-[1.9rem] md:text-[1.6rem] text-[1.3rem]"
                } cursor-pointer`}
              />
              ...
              <Link to="/contact">
                <button
                  className={`${
                    scrolling
                      ? "2xl:w-[11.5rem] xl:w-[9.5rem] lg:w-[7.5rem] md:w-[5.5rem] w-[6rem] 2xl:h-[3.8rem] xl:h-[3.2rem] lg:h-[2.5rem] md:h-[2rem]"
                      : "2xl:w-[12rem] xl:w-[10rem] lg:w-[8rem] md:w-[6rem] w-[10rem] 2xl:h-[4rem] xl:h-[3.5rem] lg:h-[2.7rem] md:h-[2.3rem]"
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/contact">
                ...
                <button
                  ...
                  } border-[1px] border-white px-2 py-1 rounded-md text-white`}
                >
                  Contact us
                </button>
              </Link>
          ...
          <div
            // style={{width:`30%`}}
            className={`md:hidden absolute z-30 top-0 right-0 w-64 h-screen bottom-0 duration-500 ${
              menu ? "translate-x-0" : "translate-x-full"
            }`}
          >
            <div
              className={`w-full ${scrolling ? "h-[3.5rem]" : "h-[4rem]"}  `}
            ></div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-4">
                  {Navdata.map((item, index) => (
                    <div
                    key={item.id || index}
                      className="flex flex-col items-start w-52 rounded-md border-[2px] border-black/50 py-3 pl-2 bg-white"
                      onClick={() => {
                        setbtn(!btn);
                        setbtnindex(index);
                        if (!item.subbuthai) {
                    ...
                    >
                      <NavLink
                        to={!item.subbuthai && item.add}
                        onClick={() =>
                          window.scrollTo({ top: 0, behavior: "smooth" })
                        }
                      >
                        <button
                          className="text-lg font-subMenuFont text-left w-full"
                      ...
                      {item.subbuthai && (
                        <div
                          className={`flex w-full flex-col pl-4 items-start gap-1 pt-2 pr-1 duration-300 overflow-hidden ${
                            btn && btnindex === index ? "flex" : "hidden"
                          }`}
                        >
                          {item.subbut.map((sub) => (
                            <button
                              ...
                              className=" border-b-[1px] py-1 text-left w-full pl-1"
                            >
                              {sub.subbutname}
                            </button>
                          ))}
        ...
        <div
          className={`fixed top-0 z-40 w-full h-full duration-500 ${
            menu || ishover
              ? "backdrop-blur-md md:backdrop-blur-sm block"
              : "backdrop-blur-0 hidden"
          }`}
        ...
        <div
          className={` backdrop-brightness-50 fixed  z-40 top-0 2xl:w-[6rem] pb-2 xl:w-[5rem] lg:w-[4.8rem] md:w-[3.5rem] h-full border-r-[1px] border-gray-400 hidden md:flex flex-col justify-between gap-14 items-center`}
        >
          <div
            className={`${
              ishover ? "hidden" : "block"
            } h-[100%] mt-32 py-[1px] flex justify-center w-2 rounded-xl border-[1px] border-gray-400`}
          >
            <div
          ...
          <div
            className={`${
              ishover ? "hidden" : "block"
            } flex flex-col justify-end pb-1 items-center gap-[5%]  text-white h-[50%] w-[100%]`}
          >
          ...
          <div
            className={`fixed z-50 overflow-hidden h-full top-0 left-0 bottom-0 items-center  hidden md:flex flex-col duration-500 ${
              ishover
                ? "2xl:w-[24rem] xl:w-[22rem] lg:w-20rem] md:w-[18rem] "
                : "w-0 "
            }`}
            onMouseLeave={() => setIsHover(false)}
          >
            <div
              className={` w-full  ${
                scrolling
                  ? "2xl:h-[6rem] xl:h-[5rem] lg:h-[4rem] md:h-[3rem] h-[2.8rem] lg:pb-[4rem] xl:pb-20 pb-12 2xl:pb-24"
                  : "2xl:h-[7rem] xl:h-[6rem] lg:h-[5rem] md:h-[4rem] h-[3.5rem] lg:pb-[4.5rem] xl:pb-20 pb-16 2xl:pb-24"
              }`}
            ></div>
            <div
              className={`relative  top-0 hidden md:flex w-full h-full bg-white  2xl:pl-[4.3rem] xl:pl-[4rem] lg:pl-[2rem] md:pl-[2rem] overflow-y-auto`}
            >
              <div
                ...
                {Navdata.map((item, index) => (
                  ...
                  >
                    ...
                    <NavLink
                      ...
                      className="z-50 flex items-center 2xl:text-xl md:text-base w-full h-full bg-black/30 text-left px-4 rounded-sm text-gray-100 font-NavMenuFont font-semibold "
                    >
                      <button>{item.buttoname}</button>
                    </NavLink>
                  </div>
                ))}
